    ...
    <div className="flex md:flex-row flex-col-reverse justify-between">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        <CustomButton 
          ...
          styles={address ? 'bg-[#FFCB9A] text-black' : 'bg-[#FFCB9A] text-black'}
          handleClick={() => {
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        ...
        <div className={`absolute top-[100px] right-0 left-0 bg-[#1c1c24] z-10 shadow-secondary py-4 ${!toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} transition-all duration-700`}>
          <ul className="mb-4">
            {navlinks.map((link) => (
